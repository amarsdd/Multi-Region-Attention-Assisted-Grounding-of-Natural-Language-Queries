...
class Config(object):
    ...
    # Supported values are: resnet50, vgg16.
    ...
    # The strides of last layer of the backbone network.
    BACKBONE_STRIDES = [16]
    ...
    TOP_DOWN_PYRAMID_SIZE = 300

    # Number of classification classes (including background)
    # background + correct phrase + incorrect phrase
    NUM_CLASSES = 2
    ...
    # Match anchor to GT boxes (positive/negative)
    RPN_MIN_OVERLAP = 0.3
    RPN_MAX_OVERLAP = 0.7
